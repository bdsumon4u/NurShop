                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-8">
                        <div class="text-md-right">
                            ...
                            <button type="button" class="btn btn-info btn-redx-csv btn-xs waves-effect waves-light mr-2 float-right">
                                <i class="fas fa-file-csv mr-1"></i> REDX CSV
                            </button>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function () {
            var table = $("#orderTable").DataTable({
                ...
                columns: [
                    ...
                    {data: "courier",width: "10%",searchable:false},
            ...
            $(document).on('click','.btn-print',function (e) {
                ...
                if (ids.length > 0) {
                    ...
                    swal("Oops...!", "Select at last one", "error");
                        ...
                        $(document).on('click','.btn-redx-csv',function (e) {
                e.preventDefault();
                var rows_selected = table.column(0).checkboxes.selected();
                var ids = [];
                $.each(rows_selected, function (index, rowId) {
                ...
                if (ids.length > 0) {
                    jQuery.ajax({
                        type: "get",
                        url: "{{url('manager/order/csvExportRedxStore')}}",
                        contentType: "application/json",
                        data: {
                            ids: ids
                        },
