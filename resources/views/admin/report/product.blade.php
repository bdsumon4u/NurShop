                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select id="orderStatus" class="form-control">
                                        ...
                                        <option value="Customer Confirm">Customer Confirm</option>
                                        <option value="Request to Return">Request to Return</option>
                                        <option value="Invoiced">Invoiced</option>
                                        <option value="Delivered">Delivered</option>
                                        <option value="Customer On Hold">Customer On Hold</option>
